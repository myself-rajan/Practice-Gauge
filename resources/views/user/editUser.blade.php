...
@section('content')
    <!--   <script src="{{asset('js/views/editUser.js')}}"></script> -->
    <script src="{{asset('js/cropper/cropper.js')}}"></script>
    <script src="{{asset('js/cropper/jquery-cropper.min.js')}}"></script>
    <script src="{{asset('js/views/userDetail.js')}}"></script>
    <link href="{{asset('js/cropper/cropper.css')}}" rel="stylesheet" />
      <div class="row">
        <div class="col-sm-4 col-md-3 col-xxl-2">
          <div class="position-relative">

            <img src="{{ isset($profile_image) ? $profile_image : asset('img/Oliver_Queen.jpg') }}" class="img-fluid img-thumbnail bg-white mb-2 w-100" alt="Profile Picture" id="showProfilePicAdd">
            <input type="hidden" name="profile_path" id="profile_path" value="{{ isset($profile_image) ? $profile_image : asset('img/users/Oliver_Queen.jpg') }}">
          ...
          <input type="hidden" name="user_id" id="user_id" value="{{isset($id)?$id:''}}"> 
          <div class="col-sm-4 col-md-4 col-xxl-4">
            <div class="form-group">
              <label>First Name</label>
              <input class="form-control form-control-sm validate_blur" type="text" id="first_name" name="first_name"  placeholder="First Name" value="{{isset($fname)?$fname:''}}" tabindex="1">
            </div>
            <div class="form-group">
              <label>Email</label>
              <input class="form-control form-control-sm validate_blur" type="text" id="email" name="email"  placeholder="Email"
                value="{{isset($email)?$email:''}}" onkeyup="checkEmail()" tabindex="3" disabled>
              ...
              <input class="form-control form-control-sm validate_blur" type="password" id="password" name="password"  placeholder="Password"
                value="{{isset($pwd)?$pwd:''}}"  tabindex="5" >
