...
<section id="secQB">
  <input type="hidden" name="email" id="email" value="{{ isset($cpaData->email) ? $cpaData->email : '' }}">
  <input type="hidden" name="name" id="name" value="{{ isset($cpaData->first_name) ? $cpaData->first_name : '' }}">
  <input type="hidden" name="company_id" id="company_id" value="{{ isset($companyId) ? $companyId : '' }}">


  <input type="hidden" name="client_name" id="client_name" value="{{ isset($clientData->first_name) ? $clientData->first_name : '' }} {{ isset($clientData->last_name) ? $clientData->last_name : '' }}">
