...
<section class="business-model">
    <div class="container">
       <h2> <div class="col-sm-12 text-blue">Integration: TrueRev with QuickBooks Online</div></h2>
        <br> <br>
        <ol>
            <li><p><span style="font-weight: 400;"></span><span style="font-weight: 400;">Login to <a href="https://app.truerev.com">TrueRev</a> and Click on </span><strong>Settings </strong><span style="font-weight: 400;"> >> </span><strong>Integrations tab.</strong></p>
                <p><strong><img src="{{ asset('/images/img/1.png') }}" alt="1_-_Integrations.png" width="900" height="450"></strong></p>
                   <p>&nbsp;</p>
            </li>

            <!-- <li>
                <p>Click on <strong>QuickBooks</strong>.</p>
            </li> -->

            <li>
                <p><strong><span style="font-weight: 400;"> In the QuickBooks Online section, click on </span>Connect button. <span style="font-weight: 400;"> You’ll be redirected to QuickBooks and prompted for login.</span></strong></p>
                <p><strong><img src="{{ asset('/images/img/2.png') }}" alt="1_-_Integrations.png" width="900" height="450"></strong></p>
                   <p>&nbsp;</p>
            </li>

            <li>
                <p><span style="font-weight: 400;">To authorize TrueRev, log in to your QuickBooks Online account.</span></p>
                <p><strong><img src="{{ asset('/images/img/3.jpg') }}" alt="1_-_Integrations.png" width="900" height="600"></strong></p>
                   <p>&nbsp;</p>
            </li>
            <li>
                <p><span style="font-weight: 400;"><p><span style="font-weight: 400;"> Click <strong>Connect.</strong></span></p></span></p>
                <p><strong><img src="{{ asset('/images/img/4.png') }}" alt="1_-_Integrations.png" width="900" height="600"></strong></p>
                   <p>&nbsp;</p>
            </li>
            <li>
                <p><span style="font-weight: 400;"><p><span style="font-weight: 400;"> Once the connection is established, you will be automatically redirected to your TrueRev account and the data will be synced from your QuickBooks Online file. </span></p></span></p>
                <p><strong><img src="{{ asset('/images/img/5.jpg') }}" alt="1_-_Integrations.png" width="900" height="450"></strong></p>
                   <p>&nbsp;</p>
            </li>
        </ol>

        <div><p style="padding-left: 16px;"> Please contact <a href="mailto:support@truerev.com" class="text-blue"><i class="fa fa-envelope"></i> support@truerev.com </a> for any queries. Thank you!</p></div>
    </div>
</div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right">
                &copy; Copyright 2018 TrueRev. All rights reserved.
            </div>
