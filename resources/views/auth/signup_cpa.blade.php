                ...
                <div class="col">
                  <div>
                    ...
                    @foreach($region as $value)
                      <!-- <input type="checkbox" id="region_{{$value['id']}}" name="region[]" class="custom-control-input checkbox validate_blur" value="{{$value['id']}}" >
                      <label class="custom-control-label checkbox" for="region_{{$value['id']}}">{{$value['state']}}</label> -->
