      ...
      <div class="registration-panel">
        <div id="registrationSlider" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item {{($steps == 1)?'active':''}}">
              <!-- Basic Details -->
              <section id="secBasic">
                      ...
                      <div class="row border-top mt-3">
                        <div class="col-4 pb-3">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control form-control-sm" type="text" id="cEmail" name="cEmail" placeholder="" value="{{isset($email)?$email:''}}" tabindex="" disabled />
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="form-group mt-3">
