...
<div class="mb-3 d-flex justify-content-end">
  @if(isset($company))
    @if($company->is_report_verified == 1)
  ...
  <div class="" id="fullPage" style="display: none;"><!-- style="visibility: hidden" -->
    <div id="contentPage" style="margin-left:10%;padding: 0px 0px 0px 0px;width: 80%;height: 100%;"><!-- style="margin-left:10%;padding: 0px 0px 0px 0px;width: 80%;height: 100%;" -->
        <div><!--  style="height:100px" -->
          <h2 style="text-align: center">{{ \Session::get('company')['global_company_name'] }}
          </h2>
          <input type="hidden" name="company_name" id="company_name" value="{{ \Session::get('company')['global_company_name'] }}">
...
<script type="text/javascript">
  ...
  $('#apply_filter').click(function() {
    ...
    function getDashboard(checkedVal, month, dateVal='', filter_type='', from_date='', to_date='', compare_with, checked_period) {
      ...
      $.ajax({
        url:'{{route("monthly_collection_report")}}',
        type:'POST',
        data:{
          year:checkedVal,
          month:month,
      ...
      $.ajax({
        url:'{{route("gross_net_collection_report")}}',
        type:'POST',
        data:{
          year:revCheckedVal,
          month:month,
      ...
      $.ajax({
        url:'{{route("operational_expenses_report")}}',
        type:'POST',
        data:{
          year:checkedVal,
          month:month,
