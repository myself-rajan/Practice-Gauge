...
<html lang="en">
  <head>
    ...
    <script src="<?php echo e(asset('/js/views/registration_std.js')); ?>"></script>
                      ...
                      <div class="row border-top mt-3">
                        <div class="col-4 pb-3">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control form-control-sm" type="text" id="cEmail" name="cEmail" placeholder="" value="<?php echo e(isset($email)?$email:''); ?>" tabindex="8" disabled />
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="form-group mt-3">
...
<script type="text/javascript">
  ...
  $("#skip_qbo").click(function(){
    ...
    $.ajax({
      url:"<?php echo e(route('skipQboStd')); ?>",
      type:"POST",
