...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('/css/strawberry.login.css')); ?>" rel="stylesheet" />
    <script src="<?php echo e(asset('/js/views/login.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/jQueryUI/jquery-ui.min.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('/js/jQuery_3x/jquery.min.js')); ?>"></script> -->
  ...
  <body style="overflow: hidden;">
    <div class="login-wrapper"> 
      ...
      <?php echo $__env->yieldContent('signVal'); ?>;
    </div>
  </body>
</html>