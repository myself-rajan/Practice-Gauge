    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="login-control-group">
          <label>Email</label>
           <input id="email" type="text" class="login-control validate_blur" name="email" value="<?php echo e(old('email')); ?>" />
        ...
        <div class="login-control-group">
          ...
          <a class="login-forgot-link" href="<?php echo e(route('forget_pass')); ?>">Forgot Password?</a>
        </div>
        ...
        <div style="margin-left:-25px;margin-right:-25px;" class="py-3 text-center d-none">
          <button class="btn btn-light rounded mb-1 shadow-sm">
            <img src="<?php echo e(asset('/img/btn_google_light_normal_ios.svg')); ?>" /> Sign in with Google
          </button>
        </div>
    </div>
      </form>
