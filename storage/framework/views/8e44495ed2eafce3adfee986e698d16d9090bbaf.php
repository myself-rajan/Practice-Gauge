...
?>
<script src="<?php echo e(asset('/js/views/practices.js')); ?>"></script>
    ...
    <div class="card bg-white border-0 shadow-sm rounded">
      ...
      <div class="card-body border-top">
        ...
        <div class="table-y-scroll fetch-practices-data">
          <table class="table table-sm table-no-border bg-white" >
            ...
            <tbody class="align-middle">
              <?php if(count($practicesList) > 0): ?>
                <?php $__currentLoopData = $practicesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td>
                      <span data-toggle="modal"  id="mEditPractice_model" data-target="#mEditPractice" onclick='editPracticeDetails("<?php echo e($row->id); ?>", "<?php echo e($row->company_id); ?>")' style="cursor: pointer;color: blue">
                        <h6>
                          <?php echo e($row->name); ?>
                      ...
                      <!-- <?php if($role_id == 1): ?> 
                        <td>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input subscription" name="chkUserActive_<?php echo e($key); ?>" data-userid="<?php echo e($row->id); ?>" id="chkUserActive_<?php echo e($key); ?>" tabindex="6" <?php if($row->is_subscription == 1) {?> checked <?php }?>>
                            <label class="custom-control-label" for="chkUserActive_<?php echo e($key); ?>" style="margin-bottom: 20px;"></label>
                          </div>
                        </td>
                      <?php endif; ?> -->
                    <?php if($row->is_report_verified == 1): ?>            
                    ...
                    <?php if($row->active == 1): ?>
                      <td>
                        <u id="sendLogin" data-id="<?php echo e($row->user_id); ?>" data-toggle="tooltip" title="Send client login" onclick='sendLogin("<?php echo e($row->user_id); ?>")' style="cursor: pointer"><a href="#">Send Email</a></u>
                    ...
                    <?php if(Auth::user()->role_id == 1 || Auth::user()->role_id == 3): ?><!-- Only Master Firm Admin -->
       ...
       <!--  <div class="list-group fetch-practices-data">
          <?php $__currentLoopData = $practicesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <a class="list-group-item list-group-item-action">
            ...
            <?php if($row->active == 1): ?>
              <button class="btn btn-sm btn-secondary float-right mr-1" id="sendLogin" data-id="<?php echo e($row->id); ?>" data-toggle="tooltip" title="Send client login" onclick='sendLogin("<?php echo e($row->id); ?>")' style="margin-top: -30px;">
                <i class="fas fa-paper-plane"></i>
              </button>
            <?php else: ?>
        ...
        <div>
          <div class="card border-0 mt-0 mb-4 mb-lg-0 mt-lg-0">
            ...
            <form class="practice_specific" id="practice_specify" name="practice_specify" method="post" style="display: none">
              <input type="hidden" name="user_id" id="user_id" value="<?php echo e(isset($_GET['confirmation_code'])?base64_decode($_GET['confirmation_code']):''); ?>">
              <input type="hidden" name="company_id" id="company_id" value="<?php echo e(isset($_GET['practices'])?base64_decode($_GET['practices']):''); ?>">
                 ...
                 <div class="col-3" role="group">
                  <div class="dropdown flex-fill block-picker year-dropdown">  
                    ...
                    <a class="form-control form-control-sm " data-toggle="dropdown" data-select>
                      <span class="text" id="year"><?php echo e(isset($as_year) ? $as_year : date('Y')); ?></span>
                    ...
                    <div class="year_started dropdown-menu shadow" style="">
                      <?php $__currentLoopData = $yearArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a data-year="<?php echo e($year); ?>" class="dropdown-item <?php echo e(isset($as_year) && $year == $as_year ? 'active' : ''); ?>"><?php echo e($year); ?></a>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="entity_count" name="entity_count">
                      <?php $__currentLoopData = $entity_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-3">
                  <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="practices_count" name="practices_count">
                     <?php $__currentLoopData = $practices_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value['id']); ?>"><?php echo e($value['name']); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<script type="text/javascript">
  ...
  $('.search').keyup(function() {
    ...
    $.ajax({
      url: "<?php echo e(route('search_practices')); ?>",
      type: 'POST',
      data: {
        search: $('.search').val(),
  ...
  function sendLogin(id){
    ...
    $.ajax({
      url:'<?php echo e(route("sendLoginPwd")); ?>',
      type:'POST',
      data:{'id':id},
      success: function(response) {
  ...
  function editPracticeDetails(id, company_id){
    ...
    $.ajax({
      url:'<?php echo e(route("edit_practice_details")); ?>',
      type:'POST',
      data:{
        id:id,
  ...
  /*$('.btn-back').click(function() {
    ...
    function confirmReport(user_id, checked) {   
      $.ajax({
        url: "<?php echo e(route('update_subscription')); ?>",
        type: 'POST',
        data: {
          user_id: user_id,
          checked : checked,
    ...
    function deleteUser() {
      ...
      {
       var company_id = "<?php echo e(Session::get('company')['company_id']); ?>";
         $.ajax({
            url: '<?php echo e(route("confirm_delete")); ?>',
            type: 'POST',
            data: {
              'company_id' : company_id,
            },
            success: function(response) {
              window.location.href = '<?php echo e(route('select_company')); ?>';
            }
        });
      }
    }
