...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('css/app_modules/integration.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/app_modules/connected.list.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/app_modules/registration.css')); ?>" rel="stylesheet" />
      ...
      <div class="registration-panel">
        <div id="registrationSlider" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item <?php echo e(($steps == 1)?'active':''); ?>">
              <!-- Basic Details -->
              <section id="secBasic">
                <div class="card border-0 mt-0 mb-4 mb-lg-0 mt-lg-0">
                  ...
                  <form id="basic_information" name="basic_information" method="post">
                    <?php echo csrf_field(); ?>
                      ...
                      <div class="row">
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="" id="pName" name="pName" value="<?php echo e(isset($practices_name)?$practices_name:''); ?>"  tabindex="1"/>
                          </div>
                          <div class="form-group">
                            <label>City</label>
                      ...
                      <div class="row border-top mt-3">
                        <div class="col-4 pb-3">
                          <div class="form-group mt-3">
                            ...
                            <input class="form-control form-control-sm" type="text" id="cName" name="cName" placeholder="" value="<?php echo e(isset($name)?$name:''); ?>" tabindex="6"/>
                          </div>

                          <div class="form-group">
                            <label>Contact person email</label>
                            <input class="form-control form-control-sm" type="text" id="cEmail" name="cEmail" placeholder="" value="<?php echo e(isset($email)?$email:''); ?>" tabindex="" disabled />
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="form-group mt-3">
                        ...
                        <div class="col-4 bg-light border-left pb-3">
                          ...
                          <div class="form-group mt-3">
                            ...
                            <div class="custom-control custom-checkbox">
                              <input type="radio" id="rdbPreferred_email" name="rdgPreferred" class="custom-control-input" value="1" tabindex="8"
                                checked>
                    ...
                    <div class="card-footer">
                      <div class="clearfix">
                        <div id="errorMsg"></div>
                        <button type="button" class="float-right btn btn-sm btn-primary" id="btnSaveBasic" tabindex="10"><i
            ...
            <div class="carousel-item <?php echo e(($steps == 2)?'active':''); ?>">
                      ...
                      <div class="dropdown flex-fill block-picker year-dropdown">  
                        ...
                        <div class="year_started dropdown-menu shadow" style="">
                          <?php $__currentLoopData = $yearArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="dropdown-item <?php echo e(isset($as_year) && $year == $as_year ? 'active' : ''); ?>"><?php echo e($year); ?></a>                       
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                      </div>
                    </div>
            ...
            <div class="carousel-item <?php echo e(($steps == 3)?'active':''); ?>">
              <!-- QuickBooks Online -->
              <section id="secQB">
                <div class="card border-0 mt-0 mb-4 mb-lg-0 mt-lg-0">
                  <div class="card-body border-bottom">
                  ...
                  <input type="hidden" name="user_id_qbo" id="user_id_qbo"  value="<?php echo e(isset($_GET['confirmation_code'])?base64_decode($_GET['confirmation_code']):''); ?>">
                  <div class="card-body bg-light py-2">
                    <h4 class="my-0">
                      <button class="btn btn-sm btn-light btn-back" data-toggle="tooltip"
                  ...
                  <div class="card-body text-center disabled" id="divQB">
                    ...
                    <div id="divConnectQB" style="display:none"><!-- divQB_1 -->
                      ...
                      <div class="text-muted pt-3">
                        ...
                        Practice Gauge.<br />
                        <a href="javascript:doQuickbooksLogin();" data-href = "<?php echo e($qbo_auth_url); ?>" target="_blank" class="text-primary qbo_connect_url">Click here</a> if the window hasn't opened.
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    //window.strawberry.dropdownSelectToggler();
    //window.strawberry.dropdownFormBubbler();
    strawberry.dropdownSelectToggler();
    strawberry.dropdownFormBubbler();
