window.workspaceScript = new function () {
  ...
  _this.randomScalingPercentage = function () {
    return Math.round(window['Samples'].utils.rand(0, 100));
  };
  ...
  _this.OprExpData = {
    labels: ['Dental Supplies', 'Lab Fees', 'Marketting', 'Occupancy', 'Employee Costs', 'Administrative', 'Net Operating Expense'],
    datasets: [
...

      {
        type: 'bar',
        label: '2010',
        backgroundColor: _this.Colors[4],
        borderColor: _this.Colors[4],
        borderWidth: 1,
        data: [
          _this.randomScalingPercentage(),
          _this.randomScalingPercentage(),
          _this.randomScalingPercentage(),
          _this.randomScalingPercentage(),
          _this.randomScalingPercentage(),
      ...
      , {
        ...
        steppedLine: 'middle',
        borderDash: [5, 5],
        backgroundColor: "#F4B40011",
        borderColor: "#F4B400",//_this.Colors[0],
        borderWidth: 2,
        data: [
          _this.randomScalingPercentage(),
          _this.randomScalingPercentage(),
