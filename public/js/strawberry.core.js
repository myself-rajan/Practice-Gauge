...
var Strawberry = function () {
  ...
  this.Sidebar = function (_parent) {
    ...
    this.workspace.toggler = function () {
      $('[data-toggle="workspace-sidebar"]').on('click', function () {
        console.log($(this));
        _parent.dropdownSelectToggler();
        $($(this).data('target')).addClass('show');
        $($(this).data('target')).find('[data-dismiss=sidebar]').on('click', function () {
          $(this).closest('.workspace-sidebar').removeClass('show');
        });
      })
    }

    this.workspace.show = function () {
      $('.workspace-sidebar:not(.show)').addClass('show');
    }

    this.workspace.hide = function () {
      $('.workspace-sidebar.show').removeClass('show');
    }

    this.workspace.toggle = function () {
      $('.workspace-sidebar').toggleClass('show');
    }
  ...
  this.Dialog = function (_parent) {
    ...
    _this.confirm = function (options) {
      ...
      var _btnY = $("<button class='btn btn-sm btn-outline-success border-0 btn-yes' data-dismiss='modal'><i class='fas fa-check mr-1'></i>Yes</button>");
      var _btnN = $("<button class='btn btn-sm btn-outline-secondary border-0 btn-no' data-dismiss='modal'><i class='fas fa-times mr-1'></i>No</button>");
  ...
  this.fieldsetToggler = function () {
    ...
    $('#addCancel').click(function () {
      ...
      $('#addUser').show();
      $('#editUser').show();
      _instance.toast.show("Add cancelled by user", "info");
      _instance.toast.hide();
    })
  ...
  this.dropdownSelectToggler = function () {
    ...
    $('.dropdown:not(.dropdown-select):visible [data-select]').each(function () {
      ...
      $(this).closest('.dropdown').addClass('dropdown-select');
    })
  }
  ...
  this.dropdownFormBubbler = function () {
    ...
    $('.dropdown.dropdown-form:visible > .dropdown-menu:not(.dropdown-no-bubble)').each(function () {
      _ele = $(this);

      console.log('dropdown',_ele);
      _ele.find('[data-dismiss=dropdown]').click(function (e) {
